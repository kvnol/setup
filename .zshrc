...
alias dockermysqldump='docker-compose exec mysql sh -c "mysqldump -psecret default > /docker-entrypoint-initdb.d/createdb.sql"'
alias dockermysqlimport='docker-compose exec mysql sh -c "mysql -psecret default < /docker-entrypoint-initdb.d/createdb.sql"'

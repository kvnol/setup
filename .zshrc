...
export ZSH="/Users/din01/.oh-my-zsh"
...
alias dockermysqlimport='docker-compose exec mysql sh -c "mysql -udefault -psecret default < /docker-entrypoint-initdb.d/createdb.sql"'
alias atr='cdir=${PWD##*/} && cd ../ && ga $cdir && gcmsg "Atualiza referencia $cdir" && ggpush && cd $cdir'
alias mjml='~/node_modules/.bin/mjml index.mjml -o index.html'
...
source '/Users/din01/.zplugin/bin/zplugin.zsh'
